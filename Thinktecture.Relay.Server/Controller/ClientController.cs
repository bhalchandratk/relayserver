...
namespace Thinktecture.Relay.Server.Controller
{
    ...
    public class ClientController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> Relay(string path)
        {
            ...
            // Start waiting for response before sending the request.
            var responseTask = _backendCommunication.GetResponseAsync(onPremiseConnectorRequest.RequestId);
            ...
            var onPremiseTargetResponse = await responseTask;
