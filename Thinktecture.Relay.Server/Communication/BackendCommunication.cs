...
namespace Thinktecture.Relay.Server.Communication
{
    internal class BackendCommunication : IBackendCommunication, IDisposable
    {
        ...
        public void RegisterOnPremise(RegistrationInformation registrationInformation)
        {
            ...
            _logger.Debug("Registering on-premise {0} via connection {1}. User name: {2}, Role: {3}", registrationInformation.OnPremiseId, registrationInformation.ConnectionId, registrationInformation.UserName, registrationInformation.Role);
            ...
            {
                _requestSubscriptions[registrationInformation.ConnectionId] = _messageDispatcher.OnRequestReceived(registrationInformation.OnPremiseId, registrationInformation.ConnectionId)
